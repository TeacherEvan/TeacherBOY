### Task 7: Create ModDashboardBuilder (LINE Flex Message UI)

**Objective:** Admin dashboard with quick-reply buttons for mod mode control.

**Files:**
- Create: `src/agents/mod_mode/dashboard.py`
- Test: `tests/agents/mod_mode/test_dashboard.py`
...
```bash
git add src/agents/mod_mode/dashboard.py tests/agents/mod_mode/test_dashboard.py
git commit -m "feat(mod-mode): add ModDashboardBuilder Flex UI"
```