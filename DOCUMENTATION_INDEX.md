...
- **[DEPLOYMENT_GUIDE.md](DEPLOYMENT_GUIDE.md)** - Redirect stub (backward compatibility)
...
- **[ARCHITECTURE.md](ARCHITECTURE.md)** - Redirect stub (backward compatibility)
...
- LINE setup: [docs/guides/line-setup.md](docs/guides/line-setup.md)
- Environment variables: [docs/reference/environment.md](docs/reference/environment.md)
- Zeus AI/search commands: [docs/reference/quick-reference.md](docs/reference/quick-reference.md)
- Adding a new agent: [docs/architecture/agents.md](docs/architecture/agents.md)
