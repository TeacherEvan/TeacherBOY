...
3. [docs/reference/environment.md](docs/reference/environment.md) - Configuration
4. [docs/TRACING.md](docs/TRACING.md) - Monitoring setup
...
- **News menu not showing?** → [docs/NEWS_AGENT.md](docs/NEWS_AGENT.md)
- **Rate limiting?** → [CHANGELOG.md](CHANGELOG.md) v3.2.0
- **Performance issues?** → [OPTIMIZATION_GUIDE.md](OPTIMIZATION_GUIDE.md)
- **Monitoring?** → [docs/TRACING.md](docs/TRACING.md)

## 📝 Documentation Standards

All documentation follows these conventions:

- **Markdown format** with proper headings and syntax
- **Emoji prefixes** for quick visual scanning
- **Code examples** with syntax highlighting
- **Cross-references** between related documents
- **Version tags** in CHANGELOG.md for tracking changes

## 🆕 Latest Updates

See [CHANGELOG.md](CHANGELOG.md) for:

- **v3.2.0** (2025-12-16): Rate limiting with admin exemption
- **v3.1.0** (2025-12-16): Translation hallucination fix & news language display
- **v3.0.0** (2025-12-15): Multi-agent architecture overhaul
...
3. Update [CHANGELOG.md](CHANGELOG.md) with documentation changes
4. Follow the emoji + descriptive title format
