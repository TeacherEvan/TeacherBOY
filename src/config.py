...
class Settings(BaseSettings):
    ...
    additional_agents: Optional[str] = Field(
        default=None,
        description="JSON string with additional agent configurations"
    )
    ...
    google_calendar_group_id: Optional[str] = Field(
        default=None,
        description="LINE Group Chat ID for calendar reminders"
    )
    ...
    calendar_morning_hour: int = Field(
        ...
        ge=0,
        le=23,
        description="Hour for morning reminder (24-hour format)"
    )
    ...
    mcp_server_url: Optional[str] = Field(
        default=None,
        description="MCP server URL for extended bot capabilities"
    )
