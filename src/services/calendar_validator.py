...
class CalendarValidator:
    ...
    def validate_title(self, title: str) -> tuple[bool, str | None, str | None]:
        """
    ...
    def validate_description(self, description: str) -> tuple[bool, str | None, str | None]:
        """
        ...
        if BANNED_CHARS_PATTERN.search(description):
            ...
            logger.warning("⚠️ Removed banned characters from description")

        return True, description, None

    def validate_date(self, event_date: date) -> tuple[bool, str | None]:
        """
        Validate event date.
    ...
    def validate_reminder_days(self, reminder_days: list) -> tuple[bool, list | None, str | None]:
        """
    ...
    def validate_event(
        self, title: str, event_date: date, description: str = "", reminder_days: list | None = None
        ...
        reminder_valid, sanitized_reminders, reminder_error = self.validate_reminder_days(reminder_days or [0])
