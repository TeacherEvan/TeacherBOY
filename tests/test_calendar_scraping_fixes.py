...
class TestDateExtraction:
    ...
    async def test_extract_from_dear_all_meeting_format(self):
        ...
        messages = [f"Dear all, team standup meeting on {tomorrow_str}"]
    ...
    async def test_dateparser_fallback_for_relative_dates(self):
        ...
        messages = ["Meeting tomorrow at 2pm", "Review session next Friday"]
...
class TestEventDeletion:
    ...
    def test_remove_multiple_events(self):
        ...
        # Remove two events
        removed, failed = calendar_service.remove_events_by_ids([event1.event_id, event2.event_id], self.test_user_id)
...
class TestCalendarSessionManager:
    ...
    def test_add_mode_selection_state(self):
        ...
        calendar_session_manager.start_add_mode_selection(self.test_chat_id, self.test_user_id, is_friend=True)
    ...
    def test_removal_flow_states(self):
        ...
        calendar_session_manager.start_removal_flow(self.test_chat_id, self.test_user_id, events_data)
        ...
        calendar_session_manager.set_removal_selection(self.test_chat_id, ["evt1", "evt2"])
