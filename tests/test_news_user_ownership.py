...
def mock_news_data_service():
    ...
    service.get_weather_data = AsyncMock(return_value={"temperature": 28, "pm25": 45, "will_rain": False})
    ...
    service.get_thai_holidays = AsyncMock(
        return_value=[{"date": "Jan 01", "name_th": "วันขึ้นปีใหม่", "name_en": "New Year's Day"}]
    )
    ...
    service.get_crypto_prices = AsyncMock(
        return_value={
