...
class TestCalendarAgent:
    ...
    async def test_inline_add_bulk_fallback_routes_to_scrape_flow_with_text_first(
        ...
        with (
            patch.object(calendar_agent, "_parse_inline_add", return_value=None),
            patch.object(
                calendar_agent,
...
class TestReminderService:
    ...
    def reminder_service(self, temp_data_path):
        ...
        service.configure(line_bot_api=mock_line_api, calendar_service=calendar_service, reminder_hour=8)
        return service
